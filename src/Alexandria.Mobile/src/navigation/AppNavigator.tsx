...
function MainTabs({ navigation }: { navigation: any }) {
  return (
    ...
    >
      <Tab.Screen name="Search" component={BookSearchScreen} options={{ title: 'Search Books' }} />
      <Tab.Screen
        name="Libraries"
  ...
  if (Platform.OS === 'web' && width > MAX_CONTENT_WIDTH) {
    return (
      <View style={styles.webContainer}>
        <View style={[styles.contentContainer, { maxWidth: MAX_CONTENT_WIDTH }]}>{children}</View>
      </View>
    );
  }
