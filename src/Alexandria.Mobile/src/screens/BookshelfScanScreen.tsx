...
export default function BookshelfScanScreen() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      if (results.length === 0) {
        Alert.alert(
          'No Books Found',
          'Could not identify any books in this image. Try a clearer photo with visible book spines or covers.'
        );
      }
    } catch (error: any) {
  ...
  const handleAddSelectedToLibrary = async () => {
    ...
    try {
      ...
      if (typeof window !== 'undefined' && window.alert) {
        ...
        Alert.alert('Import Complete', message, [{ text: 'OK', onPress: () => resetForm() }]);
      }
    } catch (error) {
  ...
  const renderBookItem = ({ item, index }: { item: BookPreview; index: number }) => (
    <View style={[styles.bookItem, item.selected && styles.bookItemSelected]}>
      <TouchableOpacity style={styles.checkbox} onPress={() => toggleBookSelection(index)}>
      ...
      <View style={styles.bookActions}>
        <TouchableOpacity style={styles.editButton} onPress={() => setEditingIndex(index)}>
          <Text style={styles.editButtonText}>Edit</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.removeButton} onPress={() => removeBook(index)}>
              ...
              <ScrollView style={styles.editForm}>
                ...
                <View style={styles.fieldContainer}>
                  ...
                  <TextInput
                    ...
                    onChangeText={(text) =>
                      updateBook(editingIndex, { publisher: text || undefined })
                    }
                ...
                <View style={styles.row}>
                  ...
                  <View style={[styles.fieldContainer, { flex: 1 }]}>
                    ...
                    <TextInput
                      ...
                      onChangeText={(text) =>
                        updateBook(editingIndex, { genre: text || undefined })
                      }
                      placeholder="Genre"
                    />
                  </View>
            ...
            <View style={styles.modalButtons}>
              ...
              <TouchableOpacity
                style={[
                  styles.button,
                  styles.primaryButton,
                  creatingLibrary && styles.disabledButton,
                ]}
